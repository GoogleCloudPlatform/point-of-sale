 ...
 * loaded from an environment variable as described in {@link InventoryController#initInventoryItems()}.
 * This class contains a collection of {@link Item}s as expected from the yaml definition.
 */
