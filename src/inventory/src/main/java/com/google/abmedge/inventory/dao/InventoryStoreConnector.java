...
public interface InventoryStoreConnector {
   ...
   * This method does not return any value. Thus, if some deletion operations failed or if there
   * were no items in the store that had certain IDs, there is no special returns.
   *
